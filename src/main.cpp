...
void setup() {
    ...
    wiegand.begin(32, true);

    //initialize pins as INPUT and attaches interruptions
    pinMode(Constants::PIN_D0, INPUT);
    pinMode(Constants::PIN_D1, INPUT);
    attachInterrupt(digitalPinToInterrupt(Constants::PIN_D0), pinStateChanged, CHANGE);
    attachInterrupt(digitalPinToInterrupt(Constants::PIN_D1), pinStateChanged, CHANGE);
